...
export const tr: TranslationMap = {
  ...
  chat: {
    ...
    progressLabels: {
      shelling: "Kabuklama",
      scuttling: "Yan yürüme",
      clawing: "Pençeleme",
      pinching: "Kıstırma",
      molting: "Kabuk değiştirme",
      bubbling: "Kabarcıklanma",
      tiding: "Gelgitlenme",
      reefing: "Resifleme",
      cracking: "Kırma",
      sifting: "Eleme",
      brining: "Salamuralanma",
      nautiling: "Nautilusleme",
      krilling: "Krilleme",
      barnacling: "Midyeleme",
      lobstering: "Istakozlanma",
      tidepooling: "Gelgit havuzlama",
      pearling: "İncileme",
      snapping: "Kıstırma sesi",
      surfacing: "Yüzeye çıkma",
    },
    commands: {
