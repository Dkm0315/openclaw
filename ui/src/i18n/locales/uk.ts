...
export const uk: TranslationMap = {
  ...
  chat: {
    ...
    progressLabels: {
      shelling: "Формування панцира",
      scuttling: "Снування",
      clawing: "Чіпляння клешнями",
      pinching: "Щипання",
      molting: "Линяння",
      bubbling: "Пузиріння",
      tiding: "Припливи",
      ...
      sifting: "Просіювання",
      brining: "Засолювання",
      nautiling: "Плавання наутилусом",
      krilling: "Ловля криля",
      barnacling: "Обростання",
      lobstering: "Ловля омарів",
      tidepooling: "Дослідження калюж",
      pearling: "Пошук перлин",
      snapping: "Клацання клешнями",
      surfacing: "Виринання",
    },
    commands: {
