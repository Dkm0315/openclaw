...
export const fa: TranslationMap = {
  ...
  chat: {
    ...
    progressLabels: {
      shelling: "در حال صدف‌کاری",
      scuttling: "در حال خزیدن",
      clawing: "در حال چنگ‌زدن",
      pinching: "در حال نیشگون‌گرفتن",
      molting: "در حال پوست‌اندازی",
      bubbling: "در حال حباب‌سازی",
      tiding: "در حال جزرومد",
      reefing: "در حال صخره‌نوردی",
      cracking: "در حال شکستن",
      sifting: "در حال الک‌کردن",
      brining: "در حال نمک‌سود کردن",
      nautiling: "در حال ناتیلوس‌گردی",
      krilling: "در حال کریل‌جویی",
      barnacling: "در حال کشتی‌چسبانی",
      lobstering: "در حال خرچنگ‌گیری",
      tidepooling: "در حال آبگیرگردی",
      pearling: "در حال مرواریدجویی",
      snapping: "در حال گاز‌گرفتن",
      surfacing: "در حال بالا‌آمدن",
    },
    commands: {
